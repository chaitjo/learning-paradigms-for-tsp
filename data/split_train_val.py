...
if __name__ == "__main__":
    ...
    if opts.filename is None:
        opts.filename = f"data/tsp/tsp{opts.num_nodes}_concorde.txt"
    ...
    with open("data/tsp/tsp{}_val_concorde.txt".format(opts.num_nodes), "w", encoding="utf-8") as f:
        for line in val_data:
            f.write(line)
    
    # Create separate train data file
    with open("data/tsp/tsp{}_train_concorde.txt".format(opts.num_nodes), "w", encoding="utf-8") as f:
