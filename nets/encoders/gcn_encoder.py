...
class BatchNormNode(nn.Module):
    ...
    def __init__(self, hidden_dim):
        ...
        self.batch_norm = nn.BatchNorm1d(hidden_dim, track_running_stats=True)
...
class BatchNormEdge(nn.Module):
    ...
    def __init__(self, hidden_dim):
        ...
        self.batch_norm = nn.BatchNorm2d(hidden_dim, track_running_stats=True)
...
class GCNEncoder(nn.Module):
    ...
    def __init__(
        ...
        self.aggregation = aggregation
        # Define GCN Layers
        self.gcn_layers = nn.ModuleList([ResidualGatedGCNLayer(self.hidden_dim, self.aggregation) for _ in range(self.num_layers)])

    def forward(self, input):
        """
        Args:
            input: Input nodes and edges: ((batch_size, num_nodes, hidden_dim), (batch_size, num_nodes, hidden_nodes))
        """
        ...
        return {
            ...
            "edge_embs": e  # (batch_size, num_nodes, num_nodes, hidden_dim)
        }
