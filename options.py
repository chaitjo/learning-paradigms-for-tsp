...
def get_options(args=None):
    ...
    parser.add_argument('--epoch_size', type=int, default=1000000, help='Number of instances per epoch during training (RL only)')
    parser.add_argument('--train_dataset', type=str, default=None, help='Dataset file to use for training (SL only)')
    ...
    # Model
    parser.add_argument('--model', default='attention', help="Model: 'attention'/'pointer'")
    parser.add_argument('--encoder', default='gat', help="Graph encoder: 'gat'/'gcn'/'mlp'")
